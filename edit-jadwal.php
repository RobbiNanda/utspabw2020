            ...
            <div class="card-body">
              <form action="update-jadwal.php" method="POST">
                ...
                <div class="form-group">
                  <label>Hari</label>
                  <input type="text" name="rw" value="<?php echo $result['rw'] ?>" placeholder="(Senin-Minggu)" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="alamat" placeholder="keterangan" rows="4"><?php echo $result['alamat'] ?></textarea>
                </div>
